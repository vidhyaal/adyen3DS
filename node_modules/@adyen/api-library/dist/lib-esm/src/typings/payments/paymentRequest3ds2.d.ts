...
export declare namespace PaymentRequest3ds2 {
    ...
    const RecurringProcessingModelEnum: {
        CardOnFile: import("./paymentRequest3d").PaymentRequest3d.RecurringProcessingModelEnum;
        Subscription: import("./paymentRequest3d").PaymentRequest3d.RecurringProcessingModelEnum;
        UnscheduledCardOnFile: import("./paymentRequest3d").PaymentRequest3d.RecurringProcessingModelEnum;
    };
    type ShopperInteractionEnum = 'Ecommerce' | 'ContAuth' | 'Moto' | 'POS';
    const ShopperInteractionEnum: {
        Ecommerce: import("./paymentRequest3d").PaymentRequest3d.ShopperInteractionEnum;
        ContAuth: import("./paymentRequest3d").PaymentRequest3d.ShopperInteractionEnum;
        Moto: import("./paymentRequest3d").PaymentRequest3d.ShopperInteractionEnum;
        POS: import("./paymentRequest3d").PaymentRequest3d.ShopperInteractionEnum;
    };
}
