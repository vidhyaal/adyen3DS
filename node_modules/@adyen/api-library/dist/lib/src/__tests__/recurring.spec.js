...
var recurring_1 = require("../typings/recurring");
var recurring_2 = __importDefault(require("../services/recurring"));
var client_1 = __importDefault(require("../client"));
var createRecurringDetailsRequest = function () {
    return {
        merchantAccount: "MerchantAccount",
        recurring: { contract: recurring_1.Recurring.ContractEnum.ONECLICK },
...
beforeEach(function () {
    ...
    recurring = new recurring_2.default(client);
