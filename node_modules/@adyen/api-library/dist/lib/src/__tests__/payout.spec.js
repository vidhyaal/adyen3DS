...
var payout_2 = require("../typings/payout");
...
var mockStoreDetailRequest = function (merchantAccount) { return (__assign(__assign({}, defaultData), { entityType: payout_2.StoreDetailRequest.EntityTypeEnum.NaturalPerson, recurring: {
        contract: payout_2.Recurring.ContractEnum.ONECLICK
